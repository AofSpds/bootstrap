...
- macOS 14는 진단 전용이며 Install은 consent/lock/Homebrew/AI 작업 전에 차단한다. `test_platform_policy.py`가 그 경계를 별도 검사한다.
...
| 시나리오 | 상태 |
|---|---|
| 깨끗한 Apple Silicon macOS15+에서 ZIP/.command·권한·보안 경고·메뉴 | NOT_RUN |
