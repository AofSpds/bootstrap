@{
    ...
    Packages = @(
        ...
        @{ Id='Microsoft.VisualStudioCode'; Name='VS Code'; Group='Core'; Exe='code.cmd'; Args=@('--version'); Scope='user'; Paths=@('%LOCALAPPDATA%\Programs\Microsoft VS Code\bin\code.cmd','%ProgramFiles%\Microsoft VS Code\bin\code.cmd'); Names=@('Microsoft Visual Studio Code','Microsoft Visual Studio Code (User)'); MinVersion='1.95.0' },
        @{ Id='OpenJS.NodeJS.LTS'; Name='Node.js LTS'; Group='Core'; Exe='node.exe'; Args=@('--version'); Paths=@('%ProgramFiles%\nodejs\node.exe'); Names=@('Node.js'); MinVersion='22.16.0'; AllowedMajors=@(22,24); PinnedVersion='24.21.0'; Companions=@('npm.cmd','npx.cmd') },
